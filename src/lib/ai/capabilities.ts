...
export const SUPPORTED_ACCOUNT_TYPES: Record<string, { dbType: string; label: string; isInvestment: boolean }> = {
  ...
  'bank account': { dbType: 'bank', label: 'Bank Account', isInvestment: false },
  'bank_account': { dbType: 'bank', label: 'Bank Account', isInvestment: false },
  'savings': { dbType: 'bank', label: 'Savings Account', isInvestment: false },
  'savings account': { dbType: 'bank', label: 'Savings Account', isInvestment: false },
  'savings_account': { dbType: 'bank', label: 'Savings Account', isInvestment: false },
  'current': { dbType: 'bank', label: 'Current Account', isInvestment: false },
  'current account': { dbType: 'bank', label: 'Current Account', isInvestment: false },
  'current_account': { dbType: 'bank', label: 'Current Account', isInvestment: false },
  'salary': { dbType: 'bank', label: 'Salary Account', isInvestment: false },
  'salary account': { dbType: 'bank', label: 'Salary Account', isInvestment: false },
  'salary_account': { dbType: 'bank', label: 'Salary Account', isInvestment: false },
  'checking': { dbType: 'bank', label: 'Checking Account', isInvestment: false },
  'checking account': { dbType: 'bank', label: 'Checking Account', isInvestment: false },
  'checking_account': { dbType: 'bank', label: 'Checking Account', isInvestment: false },
  
  // Cash & Wallet
  'cash': { dbType: 'cash', label: 'Cash Account', isInvestment: false },
  'cash account': { dbType: 'cash', label: 'Cash Account', isInvestment: false },
  'cash_account': { dbType: 'cash', label: 'Cash Account', isInvestment: false },
  'cash wallet': { dbType: 'cash', label: 'Cash Wallet', isInvestment: false },
  'cash_wallet': { dbType: 'cash', label: 'Cash Wallet', isInvestment: false },
  'wallet': { dbType: 'wallet', label: 'Digital Wallet', isInvestment: false },
  'digital wallet': { dbType: 'wallet', label: 'Digital Wallet', isInvestment: false },
  'digital_wallet': { dbType: 'wallet', label: 'Digital Wallet', isInvestment: false },
  'upi': { dbType: 'wallet', label: 'UPI Wallet', isInvestment: false },
  'upi wallet': { dbType: 'wallet', label: 'UPI Wallet', isInvestment: false },
  'upi_wallet': { dbType: 'wallet', label: 'UPI Wallet', isInvestment: false },
  ...
  'credit card account': { dbType: 'credit', label: 'Credit Card Account', isInvestment: false },
  'credit_card_account': { dbType: 'credit', label: 'Credit Card Account', isInvestment: false },
  
  // Investment & Demat
  'investment': { dbType: 'investment', label: 'Investment Account', isInvestment: true },
  'investment account': { dbType: 'investment', label: 'Investment Account', isInvestment: true },
  'investment_account': { dbType: 'investment', label: 'Investment Account', isInvestment: true },
  'demat': { dbType: 'investment', label: 'Demat Account', isInvestment: true },
  'demat account': { dbType: 'investment', label: 'Demat Account', isInvestment: true },
  'demat_account': { dbType: 'investment', label: 'Demat Account', isInvestment: true },
  'broker': { dbType: 'investment', label: 'Broker Account', isInvestment: true },
  'broker account': { dbType: 'investment', label: 'Broker Account', isInvestment: true },
  'broker_account': { dbType: 'investment', label: 'Broker Account', isInvestment: true },
  ...
  'mutual fund account': { dbType: 'investment', label: 'Mutual Fund Account', isInvestment: true },
  ...
  'fixed deposit account': { dbType: 'investment', label: 'Fixed Deposit Account', isInvestment: true },
