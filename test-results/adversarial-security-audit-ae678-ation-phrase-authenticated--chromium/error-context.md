...
- Name: adversarial-security-audit.spec.ts >> API input validation >> E2E-API-03: /api/account/reset-data rejects wrong confirmation phrase (authenticated)
- Location: playwright\e2e\adversarial-security-audit.spec.ts:208:7
